...
if not (source/'include/mbedtls/version.h').exists():
    ...
    if not archive.exists():
        urllib.request.urlretrieve(f'https://github.com/Mbed-TLS/mbedtls/releases/download/mbedtls-{version}/mbedtls-{version}.tar.bz2',archive)
    expected='8fb65fae8dcae5840f793c0a334860a411f884cc537ea290ce1c52bb64ca007a'
    if hashlib.sha256(archive.read_bytes()).hexdigest()!=expected: raise SystemExit('Mbed TLS archive checksum mismatch')
